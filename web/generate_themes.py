...
settings['--primary-text-color'] = os.getenv('PRIMARY_TEXT_COLOR', 'black')
settings['--secondary-background-color'] = os.getenv('SECONDARY_BACKGROUND_COLOR', 'white')
settings['--secondary-text-color'] = os.getenv('SECONDARY_TEXT_COLOR', 'black')
settings['--tertiary-background-color'] = os.getenv('TERTIARY_BACKGROUND_COLOR', 'white')
settings['--tertiary-text-color'] = os.getenv('TERTIARY_TEXT_COLOR', 'black')
